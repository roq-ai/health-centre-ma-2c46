...
export const AppLogo = (props: AppLogoProps) => {
  ...
  const ownerRoles = ['health-centre-owner', 'health-centre-manager', 'health-centre-staff', 'health-centre-supplier'];
  const appName = `Health Centre Managment Application`;
