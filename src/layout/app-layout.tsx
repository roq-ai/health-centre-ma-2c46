...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['health-centre-owner', 'health-centre-manager', 'health-centre-staff', 'health-centre-supplier'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Items', path: '/items', entity: 'item', service: AccessServiceEnum.PROJECT, icon: FiPackage },
    {
      name: 'Item Batches',
      path: '/item-batches',
      entity: 'item_batch',
    ...
    { name: 'Item Types', path: '/item-types', entity: 'item_type', service: AccessServiceEnum.PROJECT, icon: FiTag },
    { name: 'People', path: '/people', entity: 'people', service: AccessServiceEnum.PROJECT, icon: FiUsers },
    {
      name: 'Transactions',
      path: '/transactions',
      entity: 'transaction',
